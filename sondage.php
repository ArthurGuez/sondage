...
class Satisfaction_Plugin
{
    ...
    {
        add_menu_page('Back-Office Sondage', 'Sondage', 'manage_options', 'sondage', array($this, 'menu_html'));
        add_submenu_page('sondage', 'Résultats du questionnaire', 'Résultats','manage_options','results', array($this,'menu_html'));
        add_submenu_page('sondage', 'Réinitialisation du questionnaire','Réinitialisation', 'manage_options', 'reinit', array($this,'menu_html_reinit'));
    }

    public function menu_html()
    {
        echo '<h1>'.get_admin_page_title().'</h1>';
        echo '<p>Résultats de votre sondage :</p>';
        echo $this->summary();
    }

    public static function menu_html_reinit()
    {
        global $wpdb;
        echo '<h1>'.get_admin_page_title().'<h1>';
